...
public class CalendarUpdated extends DomainEvent {
    private CalendarID calendarID;
    private Description description;
    private DateOfEvent dateOfEvent;
    private Place place;

    public CalendarUpdated(CalendarID calendarID, Description description, DateOfEvent dateOfEvent, Place place){
        super("sofka.domain.secretarydomain.calendarupdated");
